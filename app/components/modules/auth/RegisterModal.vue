...
const validate = () => {
  ...
  if (!form.nickname.trim() || form.nickname.trim().length < 2) {
    invalid.nickname = true
    errors.push('Никнейм должен быть не короче 2 символов')
  }
  ...
  >
    <div class="w-100 max-w-[calc(100vw-2rem)] rounded-3xl bg-sm-bg-1 px-6 py-7 shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
      <div class="flex flex-col items-center gap-y-5">
        ...
        <h2 class="text-lg font-semibold text-sm-text-1">Регистрация</h2>
